...
const BackToTop = () => {
  ...
  return (
    showButton && (
      <button
        onClick={scrollToTop}
        className="fixed group overflow-clip bottom-[5vw] md:bottom-[2vw] right-[5vw] md:right-[2vw] bg-white text-neutral-900 text-[2vw] md:text-[1.8vw] size-[16vw] md:size-[5vw] rounded-[100vw] shadow-[0_1.5vw_3.5vw_0_rgba(0,0,0,0.15)] md:shadow-[0_0.01vw_0.9vw_0vw_rgba(0,0,0,0.25)] hover:bg-neutral-900 hover:text-white transition duration-100 z-[999]">
